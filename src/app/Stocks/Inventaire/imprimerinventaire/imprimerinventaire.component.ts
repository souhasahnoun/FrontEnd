...
@Component({
  selector: 'app-imprimerinventaire',
  templateUrl: './imprimerinventaire.component.html',
  styleUrls: ['./imprimerinventaire.component.css'],
  providers: [DatePipe]
})
export class ImprimerinventaireComponent implements OnInit {
