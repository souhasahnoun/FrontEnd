...
@Component({
  selector: 'app-imprimerinventaire1',
  templateUrl: './imprimerinventaire1.component.html',
  styleUrls: ['./imprimerinventaire1.component.css'],
  providers: [DatePipe]
})
export class Imprimerinventaire1Component implements OnInit {
  myDate = new Date();
