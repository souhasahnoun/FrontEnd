...
@Component({
  selector: 'app-imprimeretatstock2',
  templateUrl: './imprimeretatstock2.component.html',
  styleUrls: ['./imprimeretatstock2.component.css'],
  providers: [DatePipe]
})
export class Imprimeretatstock2Component implements OnInit {
