...
@Component({
  selector: 'app-imprimeretatstock5',
  templateUrl: './imprimeretatstock5.component.html',
  styleUrls: ['./imprimeretatstock5.component.css'],
  providers: [DatePipe]
})
export class Imprimeretatstock5Component implements OnInit {
