...
@Component({
  selector: 'app-imprimeretatstock3',
  templateUrl: './imprimeretatstock3.component.html',
  styleUrls: ['./imprimeretatstock3.component.css'],
  providers: [DatePipe]
})
export class Imprimeretatstock3Component implements OnInit {
