...
@Component({
  selector: 'app-imprimeretatstock1',
  templateUrl: './imprimeretatstock1.component.html',
  styleUrls: ['./imprimeretatstock1.component.css'],
  providers: [DatePipe]
})
export class Imprimeretatstock1Component implements OnInit {
