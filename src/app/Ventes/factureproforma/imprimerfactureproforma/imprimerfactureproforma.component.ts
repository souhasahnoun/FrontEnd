...
@Component({
  selector: 'app-imprimerfactureproforma',
  templateUrl: './imprimerfactureproforma.component.html',
  styleUrls: ['./imprimerfactureproforma.component.css']
})
export class ImprimerfactureproformaComponent implements OnInit {
