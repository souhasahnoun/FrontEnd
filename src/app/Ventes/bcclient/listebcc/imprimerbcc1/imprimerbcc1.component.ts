...
@Component({
  selector: 'app-imprimerbcc1',
  templateUrl: './imprimerbcc1.component.html',
  styleUrls: ['./imprimerbcc1.component.css']
})
export class Imprimerbcc1Component implements OnInit {
  documents: Document[];
  document: Document ={
    num:null,
    date:null,
