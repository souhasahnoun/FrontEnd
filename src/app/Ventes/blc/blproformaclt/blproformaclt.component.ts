...
@Component({
  selector: 'app-blproformaclt',
  templateUrl: './blproformaclt.component.html',
  styleUrls: ['./blproformaclt.component.css']
})
export class BlproformacltComponent implements OnInit {
