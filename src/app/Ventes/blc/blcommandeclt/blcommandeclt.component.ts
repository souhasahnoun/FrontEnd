...
@Component({
  selector: 'app-blcommandeclt',
  templateUrl: './blcommandeclt.component.html',
  styleUrls: ['./blcommandeclt.component.css']
})
export class BlcommandecltComponent implements OnInit {
