...
@Component({
  selector: 'app-ligneblc',
  templateUrl: './ligneblc.component.html',
  styleUrls: ['./ligneblc.component.css']
})
export class LigneblcComponent implements OnInit {
 ...
 nom_prod:string;
  ...
  document: Document ={
   ...
   id: any;
  constructor(private clientsService :ClientsService,private produitsService :ProduitsService,private lignedocumentsService :LignedocumentsService,private documentsService :DocumentsService, private httpClient:HttpClient, private activatedRoute: ActivatedRoute) {
    ...
    modifierBL(){
      ...
      if (this.modif){
        this.documentsService.modifier(this.document).subscribe(data => {
          ...
          this.message='BL modifiée avec success';
          console.log(data);
        }, error =>{
          console.log(error);
          this.message='Erreur';
      ...
      ajouterLigneDoc(){
        ...
        console.log(this.lignedocument);
          this.lignedocumentsService.ajouter(this.lignedocument).subscribe(data => {
            ...
            this.message='ligne bon livraison ajoutée avec success';
            this.ajouter = true;
            console.log(data);
          }, error =>{
            console.log(error);
      ...
      // supprimer
    supprimer(id){
      if (confirm('vous etes sur de supprimer cet ligne bon livraison')){
        this.lignedocumentsService.supprimer(id).subscribe(data => {
          
          console.log(data);
          this.message='ligne bon livraison supprimee avec success';
        }, error =>{
          console.log(error);
          this.message='Erreur';
        });
