...
@Component({
  selector: 'app-imprimerblc1',
  templateUrl: './imprimerblc1.component.html',
  styleUrls: ['./imprimerblc1.component.css']
})
export class Imprimerblc1Component implements OnInit {
  ...
  document: Document ={
   ...
   id:number;
   imp;
  constructor(private lignedocumentsService :LignedocumentsService,private clientsService :ClientsService,private produitsService :ProduitsService,private httpClient:HttpClient, private documentsService:DocumentsService, private activatedRoute: ActivatedRoute) {
