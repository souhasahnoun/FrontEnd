...
@Component({
  selector: 'app-listefactureavoirc',
  templateUrl: './listefactureavoirc.component.html',
  styleUrls: ['./listefactureavoirc.component.css']
})
export class ListefactureavoircComponent implements OnInit {
  ...
  document: Document ={
   ...
   client: Client ={
    ...
    message: string;
  constructor(private rscsService :RscsService,private clientsService :ClientsService,private httpClient:HttpClient, private documentsService:DocumentsService, private pagerService: PagerService) { 
