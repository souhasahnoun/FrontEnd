...
@Component({
  selector: 'app-facturationcavoir',
  templateUrl: './facturationcavoir.component.html',
  styleUrls: ['./facturationcavoir.component.css']
})
export class FacturationcavoirComponent implements OnInit {
  ...
  ajouterFactureAvoirClts(){

    console.log(this.document);
      this.documentsService.ajouter(this.document).subscribe(data => {
      
        this.message='Facture avoir ajoutée avec success';
        console.log(data);
      }, error =>{
        console.log(error);
