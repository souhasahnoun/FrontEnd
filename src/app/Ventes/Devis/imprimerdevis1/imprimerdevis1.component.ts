...
@Component({
  selector: 'app-imprimerdevis1',
  templateUrl: './imprimerdevis1.component.html',
  styleUrls: ['./imprimerdevis1.component.css']
})
export class Imprimerdevis1Component implements OnInit {
