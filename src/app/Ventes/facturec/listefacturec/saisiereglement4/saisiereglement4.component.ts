...
@Component({
  selector: 'app-saisiereglement4',
  templateUrl: './saisiereglement4.component.html',
  styleUrls: ['./saisiereglement4.component.css']
})
export class Saisiereglement4Component implements OnInit {
 ...
 imp;
  ...
  societe: Societe ={
   ...
   lignebordereau: Lignebordereau ={
    ...
    message:string;
  constructor(private lignebordereauxService :LignebordereauxService,private rscsService :RscsService,private activatedRoute: ActivatedRoute,private societesService :SocietesService, private httpClient:HttpClient,private reglementcltsService :ReglementcltsService) {
    ...
    ajouterPaiement(){
      ...
      console.log(this.reglementclt);
        this.reglementcltsService.ajouter(this.reglementclt).subscribe(data => {
          ...
          this.message='reglement ajoutée avec success';
          console.log(data);
        }, error =>{
          console.log(error);
