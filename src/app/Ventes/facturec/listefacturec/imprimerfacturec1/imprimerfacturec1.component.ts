...
@Component({
  selector: 'app-imprimerfacturec1',
  templateUrl: './imprimerfacturec1.component.html',
  styleUrls: ['./imprimerfacturec1.component.css']
})
export class Imprimerfacturec1Component implements OnInit {
