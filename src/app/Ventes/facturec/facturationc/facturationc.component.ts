...
@Component({
  selector: 'app-facturationc',
  templateUrl: './facturationc.component.html',
  styleUrls: ['./facturationc.component.css']
})
export class FacturationcComponent implements OnInit {
  ...
  ajouterFacture(){
    ...
    console.log(this.document);
      this.documentsService.ajouter(this.document).subscribe(data => {
        ...
        this.message='Facture ajoutée avec success';
        console.log(data);
      }, error =>{
        console.log(error);
