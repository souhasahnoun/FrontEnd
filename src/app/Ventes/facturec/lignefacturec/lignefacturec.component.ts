...
@Component({
  selector: 'app-lignefacturec',
  templateUrl: './lignefacturec.component.html',
  styleUrls: ['./lignefacturec.component.css']
})
export class LignefacturecComponent implements OnInit {
    ...
    modifierFacture(){
      ...
      if (this.modif){
        this.documentsService.modifier(this.document).subscribe(data => {
          ...
          this.message='facture modifiée avec success';
          console.log(data);
        }, error =>{
          console.log(error);
          this.message='Erreur';
