...
@Component({
  selector: 'app-imprimeretattraitec1',
  templateUrl: './imprimeretattraitec1.component.html',
  styleUrls: ['./imprimeretattraitec1.component.css']
})
export class Imprimeretattraitec1Component implements OnInit {
