...
@Component({
  selector: 'app-journalcaisseexcel',
  templateUrl: './journalcaisseexcel.component.html',
  styleUrls: ['./journalcaisseexcel.component.css']
})
export class JournalcaisseexcelComponent implements OnInit {
