...
@Component({
  selector: 'app-imprimerfactureavoirf',
  templateUrl: './imprimerfactureavoirf.component.html',
  styleUrls: ['./imprimerfactureavoirf.component.css']
})
export class ImprimerfactureavoirfComponent implements OnInit {
