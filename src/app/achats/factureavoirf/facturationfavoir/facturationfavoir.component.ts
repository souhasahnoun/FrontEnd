...
@Component({
  selector: 'app-facturationfavoir',
  templateUrl: './facturationfavoir.component.html',
  styleUrls: ['./facturationfavoir.component.css']
})
export class FacturationfavoirComponent implements OnInit {
