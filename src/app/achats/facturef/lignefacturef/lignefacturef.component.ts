...
@Component({
  selector: 'app-lignefacturef',
  templateUrl: './lignefacturef.component.html',
  styleUrls: ['./lignefacturef.component.css']
})
export class LignefacturefComponent implements OnInit {
