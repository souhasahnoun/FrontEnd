...
@Component({
  selector: 'app-facturationf',
  templateUrl: './facturationf.component.html',
  styleUrls: ['./facturationf.component.css']
})
export class FacturationfComponent implements OnInit {
