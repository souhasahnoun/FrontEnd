...
@Component({
  selector: 'app-imprimersuivireglement2',
  templateUrl: './imprimersuivireglement2.component.html',
  styleUrls: ['./imprimersuivireglement2.component.css']
})
export class Imprimersuivireglement2Component implements OnInit {
  message:string;
