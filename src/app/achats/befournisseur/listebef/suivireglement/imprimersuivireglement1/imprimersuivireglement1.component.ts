...
@Component({
  selector: 'app-imprimersuivireglement1',
  templateUrl: './imprimersuivireglement1.component.html',
  styleUrls: ['./imprimersuivireglement1.component.css']
})
export class Imprimersuivireglement1Component implements OnInit {
  message:string;
