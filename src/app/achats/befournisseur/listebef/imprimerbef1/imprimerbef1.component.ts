...
@Component({
  selector: 'app-imprimerbef1',
  templateUrl: './imprimerbef1.component.html',
  styleUrls: ['./imprimerbef1.component.css']
})
export class Imprimerbef1Component implements OnInit {
