...
@Component({
  selector: 'app-ligneblf',
  templateUrl: './ligneblf.component.html',
  styleUrls: ['./ligneblf.component.css']
})
export class LigneblfComponent implements OnInit {
  ...
  //pour le champs select
   /**
    ...
    modifierBE(){
      ...
      ajouterLigneDoc(){
        ...
        console.log(this.lignedocument);
          this.lignedocumentsService.ajouter(this.lignedocument).subscribe(data => {
            ...
            this.message='ligne bon entree ajoutée avec success';
            this.ajouter = true;
            console.log(data);
          }, error =>{
            console.log(error);
      ...
      // supprimer
    supprimer(id){
      if (confirm('vous etes sur de supprimer cet ligne bon entree')){
        this.lignedocumentsService.supprimer(id).subscribe(data => {
          
          console.log(data);
          this.message='ligne bon entree supprimee avec success';
        }, error =>{
          console.log(error);
          this.message='Erreur';
        });
