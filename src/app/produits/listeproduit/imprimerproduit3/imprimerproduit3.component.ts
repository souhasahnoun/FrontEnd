...
@Component({
  selector: 'app-imprimerproduit3',
  templateUrl: './imprimerproduit3.component.html',
  styleUrls: ['./imprimerproduit3.component.css'],
  providers: [DatePipe]
})
export class Imprimerproduit3Component implements OnInit {
