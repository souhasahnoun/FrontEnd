...
@Component({
  selector: 'app-imprimerproduit1',
  templateUrl: './imprimerproduit1.component.html',
  styleUrls: ['./imprimerproduit1.component.css'],
  providers: [DatePipe]
})
export class Imprimerproduit1Component implements OnInit {
  myDate = new Date();
  id:number;
