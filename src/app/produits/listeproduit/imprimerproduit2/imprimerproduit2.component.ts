...
@Component({
  selector: 'app-imprimerproduit2',
  templateUrl: './imprimerproduit2.component.html',
  styleUrls: ['./imprimerproduit2.component.css'],
  providers: [DatePipe]
})
export class Imprimerproduit2Component implements OnInit {
