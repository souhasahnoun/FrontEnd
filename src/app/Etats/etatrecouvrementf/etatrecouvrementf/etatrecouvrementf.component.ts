...
@Component({
  selector: 'app-etatrecouvrementf',
  templateUrl: './etatrecouvrementf.component.html',
  styleUrls: ['./etatrecouvrementf.component.css']
})
export class EtatrecouvrementfComponent implements OnInit {
