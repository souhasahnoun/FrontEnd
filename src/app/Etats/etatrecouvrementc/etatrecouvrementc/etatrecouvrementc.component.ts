...
@Component({
  selector: 'app-etatrecouvrementc',
  templateUrl: './etatrecouvrementc.component.html',
  styleUrls: ['./etatrecouvrementc.component.css']
})
export class EtatrecouvrementcComponent implements OnInit {
