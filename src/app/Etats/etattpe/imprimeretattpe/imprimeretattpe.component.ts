...
@Component({
  selector: 'app-imprimeretattpe',
  templateUrl: './imprimeretattpe.component.html',
  styleUrls: ['./imprimeretattpe.component.css']
})
export class ImprimeretattpeComponent implements OnInit {
